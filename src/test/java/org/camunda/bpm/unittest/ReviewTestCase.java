...
public class ReviewTestCase extends BpmTestCase {
	...
	public void testPass() {
		...
		assertSingleTaskPresent(AutomaticReviewDelegate.TASK_PASSED_REV);
	}
	...
	public void testStandardReview() {
		...
		// Given we create a new process instance
		runtimeService().startProcessInstanceByKey(PROCESS_REVIEW, variables);
		assertSingleTaskPresent(AutomaticReviewDelegate.TASK_STD_REV);
	}
	...
	public void testManualReview() {
		...
		// Given we create a new process instance
		runtimeService().startProcessInstanceByKey(PROCESS_REVIEW, variables);
		assertSingleTaskPresent(AutomaticReviewDelegate.TASK_MAN_REV);
	}
	...
	public void testManualExtendedReview() {
		...
		// Given we create a new process instance
		runtimeService().startProcessInstanceByKey(PROCESS_REVIEW, variables);
		assertSingleTaskPresent(AutomaticReviewDelegate.TASK_MAN_EXT_REV);
	}
}