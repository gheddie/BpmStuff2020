...
public class DepartTrainTestCaseNew extends BpmTestCase {

	@Rule
	public ProcessEngineRule processEngine = new ProcessEngineRule();

	private static final String PROCESS_DEPART_TRAIN = "departTrainProcessNew";
	...
	@Test
	@Deployment(resources = { "departtrain/departTrainProcessNew.bpmn" })
